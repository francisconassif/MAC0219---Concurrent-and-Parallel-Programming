...
Arquivo: run_tests_body.py

Este programa é exatamente igual a run_tests.py, mas
executa os programas com o corpo quente e registra
em outro arquivo csv.

Programa em python que executa, para cada combinação
de parâmetros, 10 testes, tanto para heat_body quanto
para heat_body_cuda, certificando-se de que as saídas 
são iguais e registrando os tempos de execução em um
arquivo CSV.

Saída: test_results_body.csv
"""
...
heat_executable = "./heat_body"
heat_cuda_executable = "./heat_body_cuda"

c_output_file = "room_body.txt"
cuda_output_file = "room_body_cuda.txt"

compare_script = "compare_rooms.py"

csv_filename = "test_results_body.csv"
